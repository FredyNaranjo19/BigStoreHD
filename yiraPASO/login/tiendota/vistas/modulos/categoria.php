   <!--Una categoria-->
   <section class="bg-img1 txt-center p-lr-15 p-tb-92" style="background-image: url('vistas/img/bg-01.jpg');">
								...
								<div class="slick3 gallery-lb">
									...
									<div class="item-slick3" data-thumb="vistas/img/product-detail-03.jpg">
										<div class="wrap-pic-w pos-relative">
											...
											<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="vistas/img/product-detail-03.jpg">
												<i class="fa fa-expand"></i>
											</a>
										</div>
									</div>
